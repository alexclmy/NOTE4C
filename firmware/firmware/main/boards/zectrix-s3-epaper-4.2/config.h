...
// GPIO46, the speaker amplifier enable. Kept as documentation of the board
// wiring; the only code that drives it is Es8311AudioCodec through
// AUDIO_CODEC_PA_PIN above, which is the same pin. BoardPowerBsp used to claim
// it too and no longer does. See main/boards/zectrix-s3-epaper-4.2/board_power_bsp.h.
